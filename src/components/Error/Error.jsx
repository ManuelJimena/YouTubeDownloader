...
export const Error = ({ errortext, closeError }) => {
  return (
...
// Define PropTypes para Error
Error.propTypes = {
  errortext: PropTypes.string.isRequired, // Define errortext como un string requerido
  closeError: PropTypes.func.isRequired, // Define closeError como una función requerida
};
